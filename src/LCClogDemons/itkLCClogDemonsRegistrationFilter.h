#ifndef __itkLCCDemonsRegistrationFilter_h
#define __itkLCCDemonsRegistrationFilter_h
...
/**
 * \class LCCDemonsRegistrationFilter
 * \brief Deformably register two images using the LCC log-Demons algorithm.
 *
...
class ITK_EXPORT LCCDemonsRegistrationFilter :
public LCCDeformableRegistrationFilter<TFixedImage,TMovingImage,TField>
{
public:
  /** Standard class typedefs. */
  typedef LCCDemonsRegistrationFilter             Self;
  ...
  itkTypeMacro( LCCDemonsRegistrationFilter,LCCDeformableRegistrationFilter );
...
private:
  LCCDemonsRegistrationFilter(const Self&); //purposely not implemented
...
#include "itkLCCDemonsRegistrationFilter.txx"
#endif
